...
exports.DefaultGesturePreventer = exports.TaskScheduler = exports.EventType = void 0;
class EventType {
...
EventType.vendors = ['', 'webkit', 'moz', 'ms', 'MS', 'o', 'O'];
EventType.polyfillEventTypeMap = {
...
exports.DefaultGesturePreventer = DefaultGesturePreventer;
DefaultGesturePreventer.meta = new WeakMap();
DefaultGesturePreventer.isActivePreventDefaultPinchGesture = false;
DefaultGesturePreventer.isActivePreventDefaultPanGesture = false;
DefaultGesturePreventer.isActivePreventDefaultSelectGesture = false;
DefaultGesturePreventer.preventDefault = (event) => event.preventDefault();
DefaultGesturePreventer.emptyPromise = new Promise(() => {
});
